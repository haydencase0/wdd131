const gallery = [
    {
        image: "https://res.cloudinary.com/dasryldyl/image/upload/v1774538856/TokyoTemple_mnkoom.jpg",
    ...
    {
        image: "https://res.cloudinary.com/dasryldyl/image/upload/v1774538609/20birthday_r7pg2q.jpg",
        description: "Front of Tokyo Temple",
        tags: ["People"]
    },
    {
...
function loadMoreImages() {
    ...
    nextBatch.forEach(itemData => {
        ...
        img.src = itemData.image.replace(
            "/upload/",
